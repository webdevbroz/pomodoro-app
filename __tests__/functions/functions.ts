import { cleanPercentage } from '@/src/components/circular-progress';
...
describe("cleanPercentage", () => {
  ...
  it("testing edge cases", () => {
    ...
    // Return 100 when given 100
    expect(cleanPercentage(100)).toBe(100);

    // Return 100 when given a super duper pumper to the maxMaxMAX number
